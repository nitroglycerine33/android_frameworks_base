...
public class SignalClusterView
    ...
    protected void onAttachedToWindow() {
        ...
        res.registerContentObserver(Settings.ECLIPSE.getUriFor(Settings.ECLIPSE.STATUSBAR_SIGNAL_TEXT), false, mSettingsObserver);
        updateSettings();
    ...
    protected void updateSettings() {
        ...
        mShowSignalText = Settings.ECLIPSE.getInt(resolver,
                Settings.ECLIPSE.STATUSBAR_SIGNAL_TEXT, SignalText.STYLE_HIDE) != SignalText.STYLE_HIDE;
    }
