...
//        setLayoutParams(lp);
    ...
    private class SettingsObserver extends ContentObserver {
        ...
        private final Uri USE_SLIDER_URI =
                Settings.ECLIPSE.getUriFor(Settings.ECLIPSE.STATUSBAR_ENABLE_BRIGHTNESS_SLIDER);
    ...
    private void updateUseSlider() {
        mStatusBarSliderEnabled = Settings.ECLIPSE.getInt(mContext.getContentResolver(),
                Settings.ECLIPSE.STATUSBAR_ENABLE_BRIGHTNESS_SLIDER, 1) != 0;
    }
}
