...
public class SignalText extends TextView {
    ...
    protected void onAttachedToWindow() {
        ...
        resolver.registerContentObserver(
                Settings.ECLIPSE.getUriFor(Settings.ECLIPSE.STATUSBAR_SIGNAL_TEXT), false,
                mSettingsObserver);
        resolver.registerContentObserver(
                Settings.ECLIPSE.getUriFor(Settings.ECLIPSE.STATUSBAR_SIGNAL_TEXT_COLOR), false,
                mSettingsObserver);
    ...
    private void updateSettings() {
        ...
        mSignalColor = Settings.ECLIPSE.getInt(resolver,
                Settings.ECLIPSE.STATUSBAR_SIGNAL_TEXT_COLOR,
                Color.WHITE);
        ...
        mTextStyle = Settings.ECLIPSE.getInt(getContext().getContentResolver(),
                Settings.ECLIPSE.STATUSBAR_SIGNAL_TEXT, STYLE_HIDE);
    }
